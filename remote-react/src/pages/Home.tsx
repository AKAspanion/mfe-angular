...
function Home() {
  return (
    <div className="re-p-4">
      <div className="re-bg-base-200 re-p-4 re-rounded-xl re-border re-border-primary re-flex">
        <div className="re-w-64 re-flex re-flex-col">
          <div className="re-group">
            <Link
              ...
              <svg
                fill="currentColor"
                role="img"
                className="re-flex-shrink-0 re-w-6 re-h-6 re-text-gray-500 re-transition re-duration-75 dark:re-text-gray-400 group-hover:re-text-black"
              ...
              <span className="re-text-gray-900 re-flex-1 re-ml-3 re-whitespace-nowrap">
                Sales
              </span>
            </Link>
          </div>
        ...
        <div>
          <h1 className="re-text-2xl re-font-bold re-px-4">
